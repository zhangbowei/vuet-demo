<template>
  <div>
    <el-table :data="tableData" border style="width: 100%" class="table">
      <el-table-column fixed prop="id" label="item_id" width="100">
      </el-table-column>
      ...
      <el-table-column prop="create_datetime" label="create_datetime" width="300" :formatter="formatter">
      </el-table-column>
    ...
    <el-pagination class="pagination" layout="prev, pager, next" :total="total" :page-size="pageSize" v-on:current-change="changePage">
    </el-pagination>
